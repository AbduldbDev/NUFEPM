...
<head>
    ...
    <meta charset="UTF-8">
    <title>Fire Equipment Expiration Reminder</title>
</head>
                ...
                <table width="600"
                    ...
                    <tr>
                        <td
                            ...
                            <h1 style="color: white; font-size: 24px; margin: 0;">Fire Equipment Expiration Reminder
                            </h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 30px;">
                            <p>The following equipment is approaching expiration before
                                    ...
                                    @foreach ($extinguishers as $ext)
                                        <tr style="border-bottom: 1px solid #eee;">
                                            ...
                                            <td style="padding: 12px;">
                                                {{ \Carbon\Carbon::parse($ext->life_span)->format('M d, Y') }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
