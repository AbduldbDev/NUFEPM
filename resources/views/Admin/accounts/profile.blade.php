    ...
    <div class="main-container container">
        ...
        <div class="info-header mt-2 mt-lg-5">
            <div class="row">
                <div class="col-md-3 col-sm-4 col-xs-12">
                    @if (Auth::user()->image)
                        <img width="100%" src="{{ asset('/storage/' . Auth::user()->image) }}" alt="">
                    @else
                        <img width="100%" class="profile-pic" src="{{ asset('/Image/profile.webp') }}" alt="User Image">
                    @endif
        ...
        <div class="form-container shadow-sm">
            ...
            <div class="row mb-3">
                <div class="col-md-12 col-lg-6  mb-3 mb-md-0">
                    <div class="row align-items-center">
                        <label for="gender" class="col-md-4 col-form-label">Gender:<span class="required">*</span></label>
                        <div class="col-md-8">
