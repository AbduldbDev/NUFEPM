...
@section('content')
    ...
    <div class="main-container container ">
        <div class="title">
            ...
            <span class="crumb">
                <span class="breadcrumbs"><a href="{{ route('admin.ShowAdminInspectionMenu') }}">Inspection Records</a>
                    &gt;</span>
            </span>
            <span class="breadcrumbs">Recent</span>
        </div>
        <hr>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <div class="d-flex justify-content-center align-items-center">
                                    <a class="mx-2 edit-btn" href="{{ url('/Inspection/Logs/Answer/' . $item->id) }}">
