                ...
                <table class="sortable-table table table-responsive table-bordered w-100" id="sortableTable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center sortable" data-index="2" onclick="sortTable(this)">
                            ...
                            <th class="text-center sortable" data-index="6" onclick="sortTable(this)">
                                ...
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <a class="mx-2  edit-btn"
                                            href="{{ url('/Inspection/Logs/Table/' . $item->id) }}">
