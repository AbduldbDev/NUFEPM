        ...
        <div class="row">
            <div class="col-12 col-lg-6 p-4 rounded shadow bg-white">
                <h5 class="mb-4 fw-semibold text-center">
                    <i class="fas fa-file-export me-2 " style="color: #35408e"></i> Export Incident Logs
                </h5>
                ...
                <div class="border rounded p-3 mb-4 bg-light">
                    ...
                    <form action="{{ route('export.completedsos') }}" method="GET" class="row g-3 align-items-end">
