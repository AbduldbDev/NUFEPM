...
@section('content')
    <div class="container main-container">
        ...
        <div class="menu-grid">
            <div class="menu-card">
                <a href="{{ url('Guide/type/Fire_Hose') }}" class="card-link"></a>
                <div class="card-body">
            ...
            <div class="menu-card">
                <a href="{{ url('Guide/type/Extinguisher') }}" class="card-link"></a>
                <div class="card-body">
                    <div class="card-icon-container">
                        <div class="card-icon">
                            <i class="fa-solid fa-fire-extinguisher"></i>
            ...
            <div class="menu-card">
                <a href="{{ url('Guide/type/Emergency_Lights') }}" class="card-link"></a>
                <div class="card-body">
                    <div class="card-icon-container">
                        <div class="card-icon">
            ...
            <div class="menu-card">
                <a href="{{ url('Guide/type/Sprinklers') }}" class="card-link"></a>
                <div class="card-body">
                    <div class="card-icon-container">
                        <div class="card-icon">
            ...
            <div class="menu-card">
                <a href="{{ url('Guide/type/Smoke_Detector') }}" class="card-link"></a>
                <div class="card-body">
                    <div class="card-icon-container">
                        <div class="card-icon">
            ...
            <div class="menu-card">
                <a href="{{ url('Guide/type/Fire_Alarm') }}" class="card-link"></a>
                <div class="card-body">
                    <div class="card-icon-container">
                        <div class="card-icon">
