        ...
        <div class="card shadow-sm rounded-3 animated-container">
            <div class="card-body">
                ...
                @php
                    ...
                    $showButton = $today->between(
                        $nextMaintenance->copy()->subDays(7),
                        $nextMaintenance->copy()->addDays(7),
                    );
                ...
                <div class="mb-2">
                    <a href="{{ url('/Inspection/Start/' . $extinguisher->extinguisher_id) }}"
                        class="btn btn-outline-primary w-100"><i class="fa-solid fa-folder-open"></i> View
                        Inspection Logs</a>
                </div>
            </div>
        </div>
